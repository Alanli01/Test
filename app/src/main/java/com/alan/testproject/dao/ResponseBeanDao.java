...
public class ResponseBeanDao extends AbstractDao<ResponseBean, Void> {
    ...
    /**
     * Properties of entity ResponseBean.<br/>
    ...
    public ResponseBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ResponseBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RESPONSE_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ResponseBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ResponseBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public ResponseBean readEntity(Cursor cursor, int offset) {
        ResponseBean entity = new ResponseBean( //
            ...
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), // label_search_url
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), // notifications_url
            cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19), // organization_url
            cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20), // organization_repositories_url
            cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21), // organization_teams_url
            cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22), // public_gists_url
            cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23), // rate_limit_url
            cursor.isNull(offset + 24) ? null : cursor.getString(offset + 24), // repository_url
            cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25), // repository_search_url
            cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26), // current_user_repositories_url
            cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27), // starred_url
            cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28), // starred_gists_url
            cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29), // user_url
            cursor.isNull(offset + 30) ? null : cursor.getString(offset + 30), // user_organizations_url
            cursor.isNull(offset + 31) ? null : cursor.getString(offset + 31), // user_repositories_url
            cursor.isNull(offset + 32) ? null : cursor.getString(offset + 32) // user_search_url
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, ResponseBean entity, int offset) {
